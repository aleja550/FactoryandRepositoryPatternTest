...
{
    class PostgresSqlDb : IDataBase     // CONCRETE PRODUCT: implements the Product interface
    {

        ContactosBusiness contactosPostgresql = new ContactosBusiness(new PostgreSqlRepository());

        DataTable ContactosP = new DataTable();

        Checks verify = new Checks();

        public void Keep()
        {
            ContactosP = contactosPostgresql.Consultar();


            //Pass the file path and filename to the StreamWriter 
            StreamWriter sw = new StreamWriter("C:\\Users\\DESARROLLADOR 10\\Documents\\ContactosPosgreSQL.txt");

            sw.WriteLine("Sus contactos guardados son los siguientes: ");

            foreach (DataRow x in ContactosP.Rows)
            {
                sw.WriteLine(" \n");
        ...
        public void Add()
        {
            ...
            int insercion = contactosPostgresql.Insertar(cn.Nombre, cn.Telefono, cn.Fechanac, cn.Correo);
        ...
        public void Update()
        {
            ...
            DataTable ConsultarContacto = contactosPostgresql.ConsultarContacto(co.Id);
            ...
            int Modificar = contactosPostgresql.Modificar(co.Id, co.Nombre, co.Telefono, co.Fechanac, co.Correo);
        ...
        public void Delete()
        {
            ...
            int Eliminar = contactosPostgresql.Eliminar(cp.Id);
        ...
        public void ReadContact()
        {
            ...
            DataTable ConsultarContacto = contactosPostgresql.ConsultarContacto(con.Id);
